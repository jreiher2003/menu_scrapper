...
def city_page(url_slug_state,state_id,url_slug_city,city_id, page=1):
    ...
    return render_template('city_page.html', url_slug_state=url_slug_state, url_slug_city=url_slug_city, state_name=state_name.name,state_id=state_id, city_name=city_name.city_name, city_id=city_id, rest=rest, rest_total=city_name.r_total)
